...
def get_recipe(url, recipe_name ,unit_type="metric SI-Unit"):
    ...
    try:
        ...
        print("\nLooks like we were not able to reach the website, therefore we will create a recipe using an LLM\n")
